...
- 단계: 보너스 풀이 문제 수 선택과 무작위 출제 구현 완료
- 현재 통합 브랜치: `main`
...
힌트 사용 여부를 선택하고 힌트 사용 시 점수를 차감하는 기능을 구현한다.

- 각 퀴즈에 선택지 기반 힌트를 제공하는 방식을 결정한다.
- 힌트 사용 여부 입력과 힌트 출력 책임을 분리한다.
- 힌트 사용 문제의 점수 차감 기준을 확정한 뒤 최고 점수 계산에 반영한다.
